...
namespace Libros_maestro.Controllers
{
    public class LibrosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_libro,titulo,genero")] Libros libros)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_libro,titulo,genero")] Libros libros)
        {
            if (ModelState.IsValid)
            {
